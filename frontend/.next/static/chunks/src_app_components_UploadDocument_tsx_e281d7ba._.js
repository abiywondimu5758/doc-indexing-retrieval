(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_components_UploadDocument_tsx_e281d7ba._.js", {
            ...
            if (stemData && wordsRef.current) {
                ...
                Object.entries(stemData.posting_list).forEach({
                    "UploadDocument.useEffect": ([word, docs])=>{
                        const totalFrequency = docs.reduce({
                            "UploadDocument.useEffect.totalFrequency": (acc, d)=>acc + d.frequency
                        }["UploadDocument.useEffect.totalFrequency"], 0);
...
//# sourceMappingURL=src_app_components_UploadDocument_tsx_e281d7ba._.js.map