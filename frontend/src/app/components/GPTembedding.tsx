...
const GPTEmbeddingComponent = () => {
    ...
    const mutation = useMutation({
        mutationFn: async (text: string) => {
            const response = await axios.post('http://127.0.0.1:8000/api/embedding/gpt', { text });
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-gray-50 shadow-lg rounded">
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-6">Generate Embedding using GPT</h2>
...
export default GPTEmbeddingComponent;